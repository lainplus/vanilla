...
// rehash if usage goes over 70%
#define HIGH_WATERMARK 70

// suppress usage to 50% after rehash
...
// make room for new entries in a hashmap by removing
// tombstones and extending the bucket size if necessary
static void rehash(HashMap *map) {
  // get new hashmap size
  int nkeys = 0;
  ...
  // create new hashmap and copy all key values
  HashMap map2 = {};
